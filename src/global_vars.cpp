...
HDC2080 TempHumSensor(I2C_ADDRESS_TEMP_HUM_SENSOR, I2C_CHAN_TEMP_HUM_SENSOR);
LTC2635 TecDac(I2C_ADDRESS_DAC_TEC, I2C_CHAN_DAC_TEC);
Adafruit_ADS1015 TecAdc(I2C_ADDRESS_ADC_TEC, I2C_CHAN_ADC_TEC);
Adafruit_ADS1015 LiaAdc(I2C_ADDRESS_ADC_Lia, I2C_CHAN_INTER_BOARD);
PCF8575 GpioExpanderIc94(I2C_ADDRESS_GPIO_EXPANDER_UCBOARD_IC94, I2C_CHAN_INTER_BOARD);
PCF8575 GpioExpanderIc91(I2C_ADDRESS_GPIO_EXPANDER_UCBOARD_IC91, I2C_CHAN_INTER_BOARD);
PCF8575 GpioExpanderTia(I2C_ADDRESS_GPIO_EXPANDER_Tia, I2C_CHAN_INTER_BOARD);
PCF8575 GpioExpanderLia(I2C_ADDRESS_GPIO_EXPANDER_Lia, I2C_CHAN_INTER_BOARD);
